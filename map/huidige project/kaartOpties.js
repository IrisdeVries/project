...
console.log(voorkeurWoningwaardeArrayLaag[0])
...
function voorkeurWoningwaardeLaag(){
	for (var i = 0; i <22; i++){
...
function voorkeurWoningwaarde(){
	if (document.getElementById("radioVoorkeurWoningwaardeGemiddeld").checked){
		for (var i = 0; i <22; i++){
